...
parser.add_argument('--epoch', '-e', type=int, default=1, help='epoch num')
parser.add_argument('--model', type=str, default='model/model_policy', help='model file save path')
parser.add_argument('--state', type=str, default='model/state_policy', help='state file save path')
...
for e in range(args.epoch):
    ...
    for i in range(0, len(positions_train) - args.batchsize, args.batchsize):
        ...
        if current_step % args.eval_interval == 0:
            ...
            logging.info('epoch = {}, iteration = {}, loss = {}, accuracy = {}'.format(
                e + 1, current_step, sum_loss / itr, accuracy(t, y)))
    ...
    with torch.no_grad():
        for i in range(0, len(positions_test) - args.batchsize, args.batchsize):
            ...
            itr_test += 1
            sum_test_accuracy += accuracy(t, y)
