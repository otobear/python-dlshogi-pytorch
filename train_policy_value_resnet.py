...
parser.add_argument('--model', type=str, default='model/model_policy_value_resnet', help='model file save path')
parser.add_argument('--state', type=str, default='model/state_policy_value_resnet', help='state file save path')
